document.getElementById("btn").addEventListener("click", function () {
  ...
  let meterToFeetConversion =
    actualNumber + " meters" + " = " + valueInFeet.toFixed(3) + " feet";
  let feetToMeterConversion =
    actualNumber + " feet" + " = " + valueInMeters.toFixed(3) + " meters";
  ...
  let gallonsToLiters =
    actualNumber + " gallons" + " = " + valueInLiters.toFixed(3) + " liters";
  let litersToGallons =
    actualNumber + " liters" + " = " + valueInGallons.toFixed(3) + " gallonss";
  ...
  let poundsToKilogram =
    actualNumber + " pounds" + " = " + valueInKilograms.toFixed(3) + " kilos";
  let kilosToPounds =
    actualNumber + " kilos" + " = " + valueInPounds.toFixed(3) + " pounds";
